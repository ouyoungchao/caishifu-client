...
import com.shiliu.caishifu.activity.UserInfoActivity;
import com.shiliu.caishifu.activity.ViewPagerImageActivity;
import com.shiliu.caishifu.cons.Constant;
import com.shiliu.caishifu.model.FriendsCircle;
import com.shiliu.caishifu.model.FriendsCircleComment;
...
import com.shiliu.caishifu.utils.TextParser;
import com.shiliu.caishifu.utils.TimestampUtil;
import com.shiliu.caishifu.widget.FriendsCircleCommentListView;
import com.shiliu.caishifu.widget.FriendsCirclePhotoGridView;
...
public class FriendsCircleAdapter extends BaseAdapter {
    ...
    public FriendsCircleAdapter(List<FriendsCircle> friendsCircleList, Context context, ClickListener clickListener) {
        ...
        this.networkUtil = NetworkUtil.getInstance(mContext);
    }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        List<String> photoList = JsonUtil.jsonArrayToList(friendsCircle.getCirclePhotos(), String.class);
        ...
        List<User> likeUserList = JsonUtil.jsonArrayToList(friendsCircle.getLikeUserJsonArray(), User.class);
        ...
        List<FriendsCircleComment> commentList =
                JsonUtil.jsonArrayToList(friendsCircle.getFriendsCircleCommentJsonArray(), FriendsCircleComment.class);
    ...
    private void initPopupWindow(final FriendsCircle friendsCircle, final int position) {
        mPopupView = View.inflate(mContext, R.layout.friend_circle_interact_popup_window, null);
