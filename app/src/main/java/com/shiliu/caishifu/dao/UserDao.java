...
import com.shiliu.caishifu.utils.PinyinComparator;
...
public class UserDao {
    ...
    public List<User> getAllStarredContactList() {
        ...
        Collections.sort(starredContactList, (Comparator<? super User>) new PinyinComparator(){});
        for (User starredContact : starredContactList) {
            starredContact.setUserHeader(Constant.STAR_FRIEND_GROUP);
        }
