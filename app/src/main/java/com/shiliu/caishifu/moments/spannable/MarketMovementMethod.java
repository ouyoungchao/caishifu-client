 ...
 * @描述:
 */
public class MarketMovementMethod extends BaseMovementMethod {
    public final String TAG = MarketMovementMethod.class.getSimpleName();
    ...
    public MarketMovementMethod() {
        this.textViewBgColor = CaishifuApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = CaishifuApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }

    /**
     * @param clickableSpanBgClor 点击选中部分时的背景色
     */
    public MarketMovementMethod(int clickableSpanBgClor) {
     ...
     */
    public MarketMovementMethod(int clickableSpanBgClor, int textViewBgColor) {
